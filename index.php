...
<body>
<?php get_header(); ?>
<div class="wrapper" style="margin-bottom:6em">
	<div class="entry-list">
        ...
        <div class="navigation">
        	<div id="left"><?php previous_posts_link('Previous Page','max_pages'); ?></div>
        	<div id="right"><?php next_posts_link('Next Page') ?></div>
        </div>
        <?php endif; ?>
    	</div>
    </div>
